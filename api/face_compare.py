...
data = {"appKey": "98e997dee93a9ba21a46fc897d633bfc", "appSecret": "eb63d2ab9abe36628579b29a5ca7672b"}    # 接口参数
...
error = []  # 错误信息列表
files = [
        ('imageData', ('IMG_201903.jpg', open('D:\work\face\img\IMG_201903.jpg', 'rb'), 'image/jpg'))
        ]
...
class CreateThread:
    ...
    def thread_api(cls):
        ...
        try:
            if method == "post":
                results = requests.post(url=url, data=data,files=files,headers=headers)
            if method == "get":
