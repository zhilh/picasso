...
class personHome(object):
    ...
    def __init__(self, driver):
        ...
        self.approve_btn='xpath=>/html/body/div[3]/div/div[2]/table/tbody/tr[%d]/td[11]/a[2]'#审核按钮，每条数据的审核按钮定位根据tr值
